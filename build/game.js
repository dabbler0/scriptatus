...
(function() {
  var ANGULAR_FRICTION, ARCHER_AI, ARROW_LENGTH, ARROW_VELOCITY, AiWorker, Archer, BOARD_HEIGHT, BOARD_WIDTH, BOWSTRING_COLOR, BOW_COLOR, BOW_HEIGHT, BOW_THICKNESS, Bullet, Character, DAGGER_COLOR, DAGGER_LENGTH, DAGGER_LIFETIME, DAGGER_VELOCITY, DEFAULT_COLORS, DUMBO, FRAME_RATE, FRICTION, IMAGE_URLS, KNIGHT_AI, Knight, MAGE_AI, Mage, NECK_HEIGHT, Particle, ROGUE_AI, RenderContext, Rogue, SCRIPTS, SHIELD_RATIO, SPELL_RADIUS, Script, Spell, TORSO_PROPORTION, Vector, WALKING_PERIOD, WALKING_RATIO, WALL_HEIGHT, Wall, ace_editor, character_templates, create_ai_from_template, currently_editing, edit_screen, edit_tab_elements, element, fn, i, index_positions, infill_object, instantiate_character, j, key_codes, lose_screen, main_menu, play_game, prototype_list, rerender_tabs, script_elements, selected_element, selected_tab_element, sign, update_prototype_list, win_screen, wrap_angle,
  ...
  play_game = function() {
    ...
    characters = character_templates.map(function(x, i) {
      return instantiate_character(SCRIPTS[x], i);
    });
  ...
  ace_editor.on('change', function() {
    return SCRIPTS[character_templates[currently_editing]].ai = ace_editor.getValue();
  });
