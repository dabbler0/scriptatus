...
(function() {
  var ANGULAR_FRICTION, ARCHER_AI, ARROW_LENGTH, ARROW_VELOCITY, AiWorker, Archer, BOARD_HEIGHT, BOARD_WIDTH, BOWSTRING_COLOR, BOW_COLOR, BOW_HEIGHT, BOW_THICKNESS, Bullet, Character, DAGGER_COLOR, DAGGER_LENGTH, DAGGER_LIFETIME, DAGGER_VELOCITY, DEFAULT_COLORS, DUMBO, FRAME_RATE, FRICTION, IMAGE_URLS, KNIGHT_AI, Knight, MAGE_AI, Mage, NECK_HEIGHT, Particle, ROGUE_AI, RenderContext, Rogue, SCRIPTS, SHIELD_RATIO, SPELL_RADIUS, Script, Spell, TORSO_PROPORTION, Vector, WALKING_PERIOD, WALKING_RATIO, WALL_HEIGHT, Wall, ace_editor, allied_positions, character_templates, class_elements, context_menu, contexted_element, contexted_index, create_ai_from_template, currently_editing, edit_element, edit_screen, edit_tab_elements, element, enemy_currently_editing, enemy_prototype_list, enemy_script_elements, enemy_selected_element, enemy_selected_tab_element, enemy_tab_elements, enemy_templates, fn, fn1, i, infill_object, instantiate_character, j, k, key_codes, lose_screen, main_menu, play_game, prototype_list, rerender_enemy_tabs, rerender_tabs, save, save_timeout, script_elements, selected_class, selected_class_element, selected_element, selected_tab_element, sign, update_prototype_list, win_screen, wrap_angle,
  ...
  play_game = function() {
    ...
    characters = characters.concat(enemy_templates.map(function(x, i) {
  ...
  if ('scripts' in localStorage) {
    SCRIPTS = JSON.parse(localStorage.scripts).map(function(x) {
  ...
  if ('practice_opponent' in localStorage) {
  ...
  document.body.addEventListener('click', function(event) {
    console.log('letting go of contexted element', contexted_element);
  ...
  save = function() {
    ...
    return save_timeout = setTimeout((function() {
      return localStorage.scripts = JSON.stringify(SCRIPTS.map(function(x) {
