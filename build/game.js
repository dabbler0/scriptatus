...
(function() {
  var ANGULAR_FRICTION, ARCHER_AI, ARROW_LENGTH, ARROW_VELOCITY, AiWorker, Archer, BOARD_HEIGHT, BOARD_WIDTH, BOWSTRING_COLOR, BOW_COLOR, BOW_HEIGHT, BOW_THICKNESS, Bullet, CURRENT_USER, Character, DAGGER_COLOR, DAGGER_LENGTH, DAGGER_LIFETIME, DAGGER_VELOCITY, DEFAULT_COLORS, DUMBO, FRAME_RATE, FRICTION, IMAGE_URLS, KNIGHT_AI, Knight, MAGE_AI, Mage, NECK_HEIGHT, Particle, ROGUE_AI, RenderContext, Rogue, SCRIPTS, SHIELD_RATIO, SPELL_RADIUS, Script, Spell, TORSO_PROPORTION, Vector, WALKING_PERIOD, WALKING_RATIO, WALL_HEIGHT, Wall, ace_editor, allied_positions, character_templates, class_elements, context_menu, contexted_element, contexted_index, create_ai_from_template, currently_editing, database, edit_element, edit_screen, edit_tab_elements, element, enemy_currently_editing, enemy_prototype_list, enemy_script_elements, enemy_selected_element, enemy_selected_tab_element, enemy_tab_elements, enemy_templates, fn, fn1, github_provider, google_provider, i, infill_object, instantiate_character, j, k, key_codes, load_scripts, load_settings, login_screen, lose_screen, main_menu, play_game, prototype_list, registration_screen, rerender_enemy_tabs, rerender_tabs, save, save_settings, save_settings_timeout, save_timeout, script_elements, selected_class, selected_class_element, selected_element, selected_tab_element, sign, update_prototype_list, win_screen, wrap_angle,
